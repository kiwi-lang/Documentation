...
* Tag: |GKMinimap_tag|
* Identifier: |GKMinimap_identifier|
* Commit: |GKMinimap_commit|
...
* `Playable demo <https://setepenre.itch.io/gkminimap>`_
* `Bug Tracker <https://gitlab.com/mischievousgame/gkminimap/-/issues>`_
* `Documentation <https://mischievousgame.gitlab.io/gkminimap/>`_
